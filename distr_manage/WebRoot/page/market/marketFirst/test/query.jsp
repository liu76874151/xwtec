...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/market/marketFirst/test/query.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>一级营销方案线上测试</div>
        ...
        <form id="queryForm" name='queryForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                ...
                <tr>
                    ...
                    <th >渠道：</th>
                    <td colspan="3">
                    	<select id="channalData" disabled="disabled">
                    		<option value="">-请选择-</option>
               ...
               <tr>
                    ...
                    <th>省级审核状态：</th>
                    <td>
                    	<select id="proVerifyState">
                    		<option value="">-请选择-</option>
                    		<option value="0">待审核</option>
                    		<option value="1">审核通过</option>
                    		<option value="2" disabled="disabled">审核未通过</option>
                    	</select>
                    </td>
                    <th>线上测试状态：</th>
                    <td>
                    	<select id="testOnlineState">
                    		<option value="">-请选择-</option>
                    		<option value="0">待测试</option>
                    		<option value="1">测试通过</option>
                    		<option value="2">测试未通过</option>
                    	</select>
                    </td>
