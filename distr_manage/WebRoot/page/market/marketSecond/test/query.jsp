...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/market/marketSecond/test/query.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>二级营销案测试</div>
               ...
               <tr>
                    ...
                    <td>
                    	<select id="testOnlineState">
                    		<option value="">-请选择-</option>
                    		<option value="0" selected="selected">待测试</option>
