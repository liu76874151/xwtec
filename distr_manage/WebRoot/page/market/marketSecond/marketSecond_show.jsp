...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/market/marketSecond_show.js"></script>
</head>
<body>
...
<input type="hidden" value="<%=URLDecoder.decode(request.getParameter("cityName"),"utf-8") %>" id="cityName">
