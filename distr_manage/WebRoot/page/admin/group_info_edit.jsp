...
<html>
  <head>
	...
	<script language="javascript" type="text/javascript" src="${contextPath}/resource/scripts/uomp/admin/group_info_edit.js"></script>
  ...
  <div id="main_div" style="padding:10px;overflow:auto;">
  		<div class="breadcrumb"><span></span>用户组--修改</div>
	  		<form name="addForm" id="addForm">
	    		<!-- 展示信息内容区域开始 -->
	    		<table class="tb">
	  	  			<tr>
	  	  				<th align="right"><span class="required">*</span>用户组编码：</th>
						<td class="form_table_content"><input type="text" readonly="readonly" class="form_input" maxlength="50" id="groupIdVal" name="groupIdVal" value="" /></td>
		 			...
		 			<tr>
						...
						<td class="form_table_content">
							<input type="text" disabled="disabled" class="form_input" maxlength="50" id="groupAreaName" name="areaName" value="" />
							<input type="hidden" name="groupArea" id="groupArea" value="" />
						</td>
		 			</tr>
		 			<tr>
