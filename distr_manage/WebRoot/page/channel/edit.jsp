            ...
            target="hidIframe" enctype="multipart/form-data">
					<table class="tb" style="position:relative;">
						...
						<tr>
							...
							<td class="form_table_content2"><input type="text" class="form_input" maxlength="50" name="channelNum"  id="channelNum"  value="${param.channelNum}"/></td>
						</tr>
						<tr>
					...
					<table width="100%" height="40">
						<tr>
							<td align="center"><a href="javascript:void(0)" class="btn"
								onClick="component.updateChannel();">确认提交</a> <a
