...
<script type="text/javascript"
	src="${contextPath}/resource/scripts/uomp/channel/edit.js"></script>
            ...
            target="hidIframe" enctype="multipart/form-data">
					<table class="tb" style="position:relative;">
						<tr>
							...
							<td class="form_table_content2"><input type="text" class="form_input" disabled="disabled" maxlength="50" name="channelName"  id="channelName" /></td>
						</tr>
						<tr>
							<th align="right">渠道编码：</th>
							<td class="form_table_content2"><input type="text" class="form_input" disabled="disabled" maxlength="50" name="channelNum"  id="channelNum"  value="${param.channelNum}"/></td>
						</tr>
						<tr>
							<th align="right">英文名称：</th>
							<td class="form_table_content2"><input type="text" class="form_input" disabled="disabled" maxlength="50" name="channelEname"  id="channelEname" /></td>
						</tr>
					</table>
					<!-- 区块信息 -->
