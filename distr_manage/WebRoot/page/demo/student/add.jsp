...
<html>
	<head>
        ...
        <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/demo/student/add.js"></script>
    </head>
  	<body>
   		<div id="main_div" style="padding:10px;overflow:auto;">
  			<div class="breadcrumb"><span></span>学生信息--新增</div>
	  		<form name="addForm" id="addForm" action="" method="post">
	    		<!-- 展示信息内容区域开始 -->
	    		<table width="98%" class="tb">
  	  			<tr>
  	  				<th align="right">姓名：</th>
					<td class="form_table_content"><input type="text" class="form_input" maxlength="50" name="stuName" value="" id="stuName" /></td>
	 			...
	 			<tr>
	   				...
	   				<td class="form_table_content" colspan="3" ><input type="text" class="form_input" maxlength="100" name="stuTel" id="stuTel" /></td>
  	 			</tr>
	 			<tr>
  	   				<th align="right">家庭住址：</th>
	   				<td class="form_table_content" colspan="3" ><textarea name="stuAddr" id="stuAddr" rows="5" class="form_input"></textarea></td>
  	 			</tr>
        		</table>
	   			<!-- 展示信息内容区域结束 -->
	    		<!-- 按钮操作区域开始 -->
