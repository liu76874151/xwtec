...
<script type="text/javascript"
	src="${contextPath}/resource/scripts/uomp/org/edit.js"></script>
	...
	<div id="main_div" style="padding:10px;">
		...
		<div class="breadcrumb">
            ...
            target="hidIframe" enctype="multipart/form-data">
            		<input type="hidden" id="orgCode" value="${param.orgCode}"/>
					<table class="tb" style="position:relative;">
						<tr>
							<th width="15%" align="right">营业厅名称：</th>
					...
					<table width="100%" height="40">
						<tr>
							<td align="center"><a href="javascript:void(0)" class="btn"
								onClick="component.updateOrgInfo();">确认提交</a> <a
