...
<head>
    ...
    <script src="${contextPath}/resource/scripts/Dhtmlx/dhtmlxSuite/dhtmlxCalendar/codebase/dhtmlxcalendar.js"></script>
        <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/webinfo/daily/query.js"></script>
</head>
  
  <body>
   <div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>彩信日报信息--查询</div>
    <fieldset class="defaultFieldset">
        <legend>彩信日报信息查询</legend>
			<form id="queryForm" name='queryForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                <tr>
                    <th width="20%">类型:</th>
                    <td width="30%">
                    <input type="radio" maxlength="100" name="type" id="type1" value="1"><label for="type1">标题</label>
                    <input type="radio" maxlength="100" name="type" id="type2" value="2"><label for="type2">内容</label>
                   
                    </td>
                    
                    <th width="20%">日期：</th>
                    <td width="30%"><input type="text"  name="beginTime" id="beginTime" readonly="readonly" value=""></td>
                </tr>
