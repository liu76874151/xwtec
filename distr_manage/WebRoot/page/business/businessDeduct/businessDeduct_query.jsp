...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/buesiness/businessDeduct/businessDeduct-query.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>业务扣费方式--查询</div>
    <fieldset class="defaultFieldset">
        <legend>业务扣费方式查询</legend>
        <form id="queryForm" name='queryForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
           	 	<tr>
                    <th>扣费方式名称：</th>
                    <td><input type="text" maxlength="200" name="deductWay" id="deductWay" value=""></td>
                    <th>扣费方式编码：</th>
                    <td><input type="text" maxlength="10" name="deductNum" id="deductNum" value=""></td>
                </tr>
                <tr>
