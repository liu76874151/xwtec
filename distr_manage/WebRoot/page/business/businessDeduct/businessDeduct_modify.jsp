...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/buesiness/businessDeduct/businessDeduct-modify.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>业务扣费方式--修改</div>
    <fieldset class="defaultFieldset">
        <legend>业务扣费方式修改</legend>
        <form id="editForm" name='editForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                <tr>
                    <th width="20%">扣费方式编码：</th>
                    <td width="30%"><input disabled="disabled" type="text" maxlength="10" name="deductNum" id="deductNum" value="${param.deductNum }"><span class="errorMsg"></span></td>
                </tr>
                <tr>
