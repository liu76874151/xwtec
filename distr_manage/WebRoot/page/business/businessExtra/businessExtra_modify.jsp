...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/buesiness/businessExtra/busiExtra-modify.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>业务扩展属性--修改</div>
    <fieldset class="defaultFieldset">
        <legend>业务扩展属性修改</legend>
        <form id="editForm" name='editForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                <tr>
                    <th width="20%">属性标识：</th>
                    <td width="30%"><input disabled="disabled" type="text" maxlength="50" name="attrKey" id="attrKey" value="${param.attrKey }"><span class="errorMsg"></span></td>
                </tr>
                <tr>
                	<th width="20%">属性名称：</th>
