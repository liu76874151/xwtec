	...
	<table class="tb">
		<tr>
			...
			<td class="form_table_content">
				<select id="state_02" name="state_02" disabled="disabled">
		...
		<tr>
			...
			<td class="form_table_content">
			<input type="file" name="files_02" id="file_02"/><span class="errorMsg"></span><br>
		...
		<tr>
			...
			<td class="form_table_content">
				<input type="radio" name="dateTime_02" checked="checked" value="0" onclick="showTime_z();">无<br/>
				<input type="radio" name="dateTime_02" value="1" onclick="showTime_z();">有<br/>
				...
				--结束时间:
				<input id="endTime_02" name="endTime_02" type="text" value="" onfocus="initCalendar(this.id)"/><span class="errorMsg"></span>
				</span>
			<span class="errorMsg"></span> </td>
		</tr>
	</table>
