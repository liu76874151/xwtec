...
<html>
  <head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/buesiness/businessinfo/busi_info_query.js"></script>
  </head>
  ...
  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
   ...
   <!--tree定义开始-->
	...
	<div id="templet_left" style="height:100%;">
	    <div id="fun_tree" style="height: 100%"  class="dhtmlxTree" > 
        </div>
