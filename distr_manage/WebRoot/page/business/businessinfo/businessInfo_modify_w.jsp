	...
	<table class="tb">
		<tr>
			...
			<!-- onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;" -->
				<select id="state_01" name="state_01" disabled="disabled">
		...
		<tr>
			...
			<td class="form_table_content">
			<input type="file" name="files_01" id="file_01"/><span class="errorMsg"></span><br>
		...
		<tr>
			...
			<td class="form_table_content">
				<input type="radio" name="dateTime_01" checked="checked" onclick="showTime();" style="display: " value="0">无<br/>
				<input type="radio" name="dateTime_01" onclick="showTime();" value="1">有<br/>
				...
				--结束时间:
				<input id="endTime_01" name="endTime_01" type="text" value="" onfocus="initCalendar(this.id)"/><span class="errorMsg"></span>
				</span>
			<span class="errorMsg"></span> </td>
		</tr>
	</table>
