    ...
    <div style="padding: 10px; overflow: auto;">
		...
		<table class="tb">
			...
			<tr>
				...
				<td class="form_table_content"><input type="text" class="form_input" maxlength="50" name="busiNum" value="" id="busiNum" readonly="readonly"/>
				<span class="errorMsg"></span> </td>
 			</tr>
 			<tr>
 			...
 			<tr>
				...
				<td class="view_info_content" >
					<input type="checkbox" name="effectWay" id="effectWay0" value="0">&nbsp;即时生效
					<input type="checkbox" name="effectWay" id="effectWay1" value="1">&nbsp;次日生效
					<input type="checkbox" name="effectWay" id="effectWay2" value="2">&nbsp;次月生效
					<input type="checkbox" name="effectWay" id="effectWay3" value="3">&nbsp;次次月生效
				</td>
			</tr>
			<tr>
				<th class="view_info_title" style="width: 10%">
				...
				<td class="view_info_content" >
					<input type="checkbox" name="neffectWay" id="neffectWay0" value="0">&nbsp;即时生效
					<input type="checkbox" name="neffectWay" id="neffectWay1" value="1">&nbsp;次日生效
					<input type="checkbox" name="neffectWay" id="neffectWay2" value="2">&nbsp;次月生效
					<input type="checkbox" name="neffectWay" id="neffectWay3" value="3">&nbsp;次次月生效
				</td>
			</tr>
			<tr>
				...
				<select id="state" name="state" style="width: 150px;">
					...
					<option value="4" selected="selected">待测试</option>
					<option value="5" selected="selected">测试不通过</option>
				</select>
				<span class="errorMsg"></span> </td>
 			</tr>
 			<tr>
 			...
 			<tr>
				...
				<td class="form_table_content">
				<input type="text" class="form_input" maxlength="10" name="fee" id="fee" /> 单位:分
				<span class="errorMsg"></span> </td>
 			</tr>
 			<tr>
