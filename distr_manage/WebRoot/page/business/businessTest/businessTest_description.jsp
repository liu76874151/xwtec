    ...
    <script type="text/javascript">
        ...
        function initValidate() {
            ValidateUtil.validate({
                ...
                messages: {
                	description: {required: "请输入测试理由", minlength: "长度必须大于等于{0}", maxlength: "长度不能超过{0}"}
