...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/buesiness/businessTag/businessTag-add.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>业务标签--新增</div>
    <fieldset class="defaultFieldset">
        <legend>业务标签新增</legend>
        <form id="addForm" name='addForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                ...
                <tr>
                	<th>标签说明：</th>
                    <td>
                    	<textarea rows="8" cols="50" id="tagDesc" name="tagDesc"></textarea><span class="errorMsg"></span>
                    </td>
                </tr>
            </table>
            <!-- 按钮操作区域开始 -->
