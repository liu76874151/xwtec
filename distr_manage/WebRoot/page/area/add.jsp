...
<html>
	<head>
        ...
        <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/area/add.js"></script>
    </head>
     <%
	...
	%>
  	<body>
   		<div id="main_div" style="padding:10px;overflow:auto;">
  			<div class="breadcrumb"><span></span>地市信息--新增</div>
	  		...
	  		<form name="addForm" id="addForm" action="" method="post">
	    		...
	    		<table width="98%" class="tb">
					...
					<input type="text" class="form_input" maxlength="10" name="areaJbNum" value="" id="areaJbNum" />
					...
					<td class="form_table_content2">
					<input type="radio" value="1" name="areaJb" id="areaJb_1" ><label  for="areaJb_1"> 省级</label>
					<input type="radio" value="2" name="areaJb" id="areaJb_2"><label  for="areaJb_2"> 地区</label>
					<input type="radio" value="3" name="areaJb" id="areaJb_3" checked="checked"><label  for="areaJb_3"> 市</label>
				...
				<th align="right"><span style="color:red">&nbsp;*&nbsp;</span>地市名称：</th>
					<td class="form_table_content2">
					<input type="text" class="form_input"  maxlength="200" name="areaName" value="" id="areaName" />
				...
				<tr>
					...
					<td class="form_table_content2"><input type="text" class="form_input"  name="areaBossCode" value="" id="areaBossCode" />
					<span class="errorMsg"></span></td>
					</tr>
	 			...
	 			<tr>
	   				...
	   				<td class="form_table_content2" colspan="3" ><textarea name="areaBz" id="areaBz" rows="5" cols="40" style="resize:none"></textarea>
	   				<span class="errorMsg"></span></td>
