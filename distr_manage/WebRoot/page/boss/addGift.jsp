...
<html>
	<head>
        ...
        <script type="text/javascript" src="$<%= request.getContextPath() %>/resource/scripts/jquery.validate.min.js"></script>
        <script type="text/javascript" src="<%= request.getContextPath() %>/resource/scripts/uomp/boss/addGift.js"></script>
    </head>
	...
	<div id="main_div" style="padding:10px;">
  			<div class="breadcrumb"><span></span>一级礼品编码--新增</div>
	  		...
	  		<form name="addForm" id="addForm" action="" method="post">
	    		...
	    		<table width="98%" class="tb">
					...
					<td class="">
					<input type="text" class="form_input" maxlength="10" name="bossGiftId" value="" id="bossGiftId" />
					
					<span class="errorMsg"></span></td>
					<th align="right">礼品名称：</th>
					<td class="">
					<input type="text" class="form_input" maxlength="10" name="giftName" value="" id="giftName" />
        		...
        		<br/>
        		<div class="breadcrumb"><span></span>二级礼品编码--新增&nbsp;&nbsp;&nbsp;<input type="button" value="添加" onclick="component.addGiftSecond()"/></div>
        		<div id="giftSecondDiv">
        		</div>
