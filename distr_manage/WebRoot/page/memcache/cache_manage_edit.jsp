...
selectRowId = URLDecoder.decode(selectRowId,"utf8");
%>
...
<html>
  <head>
	...
	<script type="text/javascript" src="${contextPath}/resource/scripts/uomp/memcache/cache_manage_edit.js"></script>  
  </head>
  
  <body>
    <input type="hidden" id="selectRowId" value="<%=selectRowId %>">
    <input type="hidden" id="memKey" name="memKey">
   	<div id="main_div" style="padding:10px;overflow:auto;">
	    <div class="breadcrumb-iframe">缓存设置--修改</div>
	    <form name="cacheAddForm" id="cacheAddForm" action="" method="post">
 		    <!-- 展示信息内容区域开始 -->
 		    <table class="tb">
 			  <tr>
 				<th align="right" width="10%"><span class="required">*</span>缓存key：</th>
	              <td class="form_table_content" id="lableMemKey"></td>
	          </tr>
