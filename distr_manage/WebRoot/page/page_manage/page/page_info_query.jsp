...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/page_manage/page/page_info_query.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>页面管理--查询</div>
    <fieldset class="defaultFieldset">
        ...
        <form id="queryForm" name='queryForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                <tr>
                    <th width="20%">页面编码：</th>
                    <td width="30%"><input type="text" maxlength="100" name="pageNum" id="pageNum" value=""></td>
                    <th width="20%">页面名称：</th>
                    <td width="30%"><input type="text" maxlength="100" name="pageName" id="pageName" value=""></td>
                </tr>
                <tr>
                    <th>页面版本：</th>
                    <td>
