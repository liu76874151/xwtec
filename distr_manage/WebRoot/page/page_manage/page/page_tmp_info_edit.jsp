...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/page_manage/page/page_tmp_info_edit.js"></script>
</head>
...
<div id="main_div" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>页面模板--修改</div>
            ...
            <form name="editForm" id="editForm" action="" method="post">
                ...
                <table width="98%" class="tb">
                    <tr>
                        ...
                        <td class="form_table_content"><input type="text" class="form_input" maxlength="50" name="pageTmpNum" value="" id="pageTmpNum" readonly="readonly"/></td>
