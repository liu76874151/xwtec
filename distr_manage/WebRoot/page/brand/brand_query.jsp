...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/brand/brand_query.js"></script>
</head>
<body>
<div title="" style="padding:10px;overflow:auto;">
    <div class="breadcrumb"><span></span>品牌信息--查询</div>
    <fieldset class="defaultFieldset">
        ...
        <form id="queryForm" name='queryForm' action="" method="post">
            <table width="98%" class="defaultTable tableStyle1">
                <tr>
                    <th width="20%">品牌名称：</th>
                    <td width="30%"><input type="text" maxlength="100" name="brand_Name" id="brand_Name" value=""></td>
                    <th width="20%">品牌编码：</th>
                    <td width="30%"><input type="text" maxlength="100" name="brand_Num" id="brand_Num" value=""></td>
                </tr>
                <tr>
