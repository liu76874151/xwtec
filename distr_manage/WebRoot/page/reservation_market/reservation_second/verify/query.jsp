...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/resource/scripts/uomp/reservation_market/reservation_second/verify/query.js"></script>
...
<div title="" style="padding:10px;overflow:auto;">
    ...
    <div class="breadcrumb"><span></span>${param.marketFirstName}关联的二级预约营销方案</div>
