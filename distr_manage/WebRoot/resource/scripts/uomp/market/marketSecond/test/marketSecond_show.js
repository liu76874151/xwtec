...
var component = {
	...
	initDataGrid : function() {
		datagrid = DhtmlxUtis.createGrid('gridbox', {
			"header" : "序号,pkid,渠道,地市,二级级方案名称,活动对象,开始时间,结束时间,配置时间,配置工号,列表展示状态,线上测试,地市审核状态,省级审核状态",
			"initWidth" : "0,0,80,80,100,80,80,80,80,80,80,80,80,*",
	...
	openTestPanel:function(level){
	    ...
	    top.UOMPDialog.showSubPage("二级营销案-测试", GLOBAL_INFO.CONTEXTPATH + "/page/market/marketSecond/test/testContent.jsp?level="+level+"&marketPkId="+pkid,null,size);
	},
	areaInfo : function(){
		$.singleReq({
	         data: {
