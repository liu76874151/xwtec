...
var component = {
	...
	initDataGrid : function() {
		datagrid = DhtmlxUtis.createGrid('gridbox', {
			...
			"colTypes" : "ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,link,ro,link,link,link",
	...
	openTestPanel:function(level){
	    ...
	    top.UOMPDialog.showSubPage("一级预约营销案-测试", GLOBAL_INFO.CONTEXTPATH + "/page/reservation_market/reservation_first/test/testContent.jsp?level="+level+"&marketPkId="+pkid,null,size);
	},
	areaInfo : function(){
		$.singleReq({
	         data: {
	...
	"//page/reservation_market/reservation_second/test/marketSecond_show.jsp?marketFirstPkid="+
